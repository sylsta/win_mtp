...
__all__ = [
    'IPortableDeviceServiceCapabilities', 'IStream',
    'IPortableDevice', 'tagCAFILETIME', 'IPortableDeviceService',
    'IPortableDeviceDispatchFactory',
    '__MIDL___MIDL_itf_PortableDeviceApi_0001_0000_0001',
    '__MIDL_IOleAutomationTypes_0001', '_wireSAFEARR_UNKNOWN',
    'IPortableDeviceValues', 'tagCALPWSTR', 'tagCAI', 'tagCACLSID',
    '_tagpropertykey', '_wireSAFEARRAY',
    'PortableDeviceDispatchFactory', 'tagCLIPDATA', 'IEnumSTATSTG',
    '_SHORT_SIZEDARR', 'tagCAUL', 'PortableDeviceManager', 'tagCAL',
    'IPortableDeviceValuesCollection', 'tagCAC', 'tagCACLIPDATA',
    'tagCADBL', 'IPortableDeviceContent', '_wireSAFEARR_BRECORD',
    'tagBSTRBLOB', '_BYTE_SIZEDARR', 'IPropertyStore', 'tagCABSTR',
    'tagCAPROPVARIANT', 'IPortableDevicePropVariantCollection',
    'tagCAUI', 'PortableDeviceService',
    'IEnumPortableDeviceObjectIDs', 'PortableDeviceServiceFTM',
    '_wireSAFEARR_HAVEIID', 'tag_inner_PROPVARIANT',
    'IPortableDeviceCapabilities', '_LONG_SIZEDARR',
    '_FLAGGED_WORD_BLOB', 'IStorage', 'tagCAUB',
    '_wireSAFEARR_DISPATCH', 'IPortableDeviceContent2',
    '_wireSAFEARRAY_UNION', 'PortableDeviceWebControl',
    'IPortableDeviceManager', 'IPortableDeviceWebControl',
    '__MIDL_IOleAutomationTypes_0005', '_wireBRECORD',
    'IPortableDeviceServiceMethodCallback',
    'IPortableDeviceEventCallback', 'tagCAH',
    'IPortableDeviceProperties', 'PortableDevice', 'tagCABOOL',
    'tagBLOB', 'tagCAFLT', 'PortableDeviceFTM', 'tagCACY',
    'tagRemSNB', 'tagCAUH', '_wireVARIANT',
    'IPortableDeviceResources', 'IPortableDeviceKeyCollection',
    'wireSNB', 'tagSTATSTG', 'ISequentialStream', 'tagCALPSTR',
    'IPortableDeviceServiceMethods', 'tagCADATE',
    '__MIDL_IOleAutomationTypes_0004', '_wireSAFEARR_VARIANT',
    '__MIDL_IOleAutomationTypes_0006', '_wireSAFEARR_BSTR',
    'tagCASCODE', 'tagCABSTRBLOB', '_HYPER_SIZEDARR',
    'tagVersionedStream', 'wirePSAFEARRAY'
]
