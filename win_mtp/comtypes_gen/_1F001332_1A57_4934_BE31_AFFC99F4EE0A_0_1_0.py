...
__all__ = [
    'tagCAUH', 'tagCLIPDATA', 'tagCABOOL', '_wireSAFEARR_HAVEIID',
    'tagVersionedStream', '_FLAGGED_WORD_BLOB', 'tagCAH', 'tagCADBL',
    '__MIDL_IOleAutomationTypes_0004', 'tagSTATSTG', 'tagCAFILETIME',
    'PortableDeviceServiceFTM', 'tagCABSTR', 'IEnumSTATSTG',
    'wireSNB', 'IPortableDeviceWebControl', '_tagpropertykey',
    'IEnumPortableDeviceObjectIDs', 'tagCAUI', '_wireSAFEARR_BSTR',
    'tagBSTRBLOB', '__MIDL_IOleAutomationTypes_0006', 'tagCALPWSTR',
    '__MIDL_IOleAutomationTypes_0005', 'tagCABSTRBLOB', 'tagCAC',
    '_wireBRECORD', '_wireSAFEARR_BRECORD', 'PortableDevice',
    'PortableDeviceService', 'IPortableDevice',
    '_wireSAFEARR_DISPATCH', 'tagCAI', 'IPortableDeviceService',
    '_HYPER_SIZEDARR', '_wireSAFEARRAY', 'IPortableDeviceContent2',
    'PortableDeviceFTM', 'IPortableDeviceCapabilities',
    '_wireVARIANT', 'tagCADATE', 'IPortableDeviceManager',
    'tagCACLSID', 'tagBLOB', 'tagCAFLT', 'tag_inner_PROPVARIANT',
    '_SHORT_SIZEDARR', 'IPortableDeviceProperties', 'tagCAUB',
    'ISequentialStream', 'tagRemSNB', 'IStorage',
    'IPortableDeviceResources', 'IStream',
    'IPortableDeviceKeyCollection', 'tagCACLIPDATA', 'IPropertyStore',
    'tagCASCODE', 'IPortableDeviceServiceMethodCallback',
    '__MIDL___MIDL_itf_PortableDeviceApi_0001_0000_0001',
    'IPortableDeviceServiceCapabilities',
    'IPortableDevicePropVariantCollection',
    'IPortableDeviceEventCallback', 'IPortableDeviceValues',
    '_wireSAFEARRAY_UNION', 'tagCACY', 'tagCAUL',
    'PortableDeviceWebControl', 'PortableDeviceDispatchFactory',
    'tagCALPSTR', '_wireSAFEARR_VARIANT', 'PortableDeviceManager',
    'tagCAL', 'IPortableDeviceContent',
    '__MIDL_IOleAutomationTypes_0001',
    'IPortableDeviceValuesCollection', '_wireSAFEARR_UNKNOWN',
    '_BYTE_SIZEDARR', '_LONG_SIZEDARR', 'tagCAPROPVARIANT',
    'IPortableDeviceServiceMethods', 'wirePSAFEARRAY',
    'IPortableDeviceDispatchFactory'
]

_check_version('1.2.0', 1662606543.844543)
