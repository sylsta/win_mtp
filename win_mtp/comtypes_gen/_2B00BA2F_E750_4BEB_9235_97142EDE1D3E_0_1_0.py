...
__all__ = [
    '__MIDL_IOleAutomationTypes_0005', 'tagCAUH', 'tagCABSTRBLOB',
    'PortableDevicePropVariantCollection', 'WpdSerializer',
    'IPortableDevicePropVariantCollection', 'tagCLIPDATA',
    '_wireVARIANT', 'tagCAC', 'tagCABOOL', 'tagCADATE', 'tagCACLSID',
    'PortableDeviceValuesCollection', '_wireSAFEARRAY_UNION',
    'IPortableDeviceValues', '_wireSAFEARR_HAVEIID',
    'tagVersionedStream', 'tagBLOB', 'tagCAUL', 'tagCACY',
    'PortableDeviceValues', 'tagCAFLT', '_wireBRECORD',
    '_wireSAFEARR_BRECORD', 'tag_inner_PROPVARIANT',
    '_FLAGGED_WORD_BLOB', '_SHORT_SIZEDARR', 'tagCAH', 'tagCADBL',
    '__MIDL_IOleAutomationTypes_0004', 'tagSTATSTG', 'tagCAFILETIME',
    'tagCAUB', 'ISequentialStream', 'tagCALPSTR',
    '_wireSAFEARR_VARIANT', '__MIDL_IOleAutomationTypes_0001',
    'tagCABSTR', 'tagCAL', 'IWpdSerializer',
    'IPortableDeviceValuesCollection', 'tagRemSNB',
    '_wireSAFEARR_UNKNOWN', 'IEnumSTATSTG', '_wireSAFEARR_DISPATCH',
    'wireSNB', 'IStorage', 'PortableDeviceKeyCollection',
    '_BYTE_SIZEDARR', 'tagCAI', '_LONG_SIZEDARR', 'tagCAPROPVARIANT',
    '_tagpropertykey', 'tagCAUI', 'IStream', 'tagCACLIPDATA',
    '_HYPER_SIZEDARR', '_wireSAFEARRAY', '_wireSAFEARR_BSTR',
    'IPortableDeviceKeyCollection', 'IPropertyStore', 'tagCASCODE',
    '__MIDL___MIDL_itf_PortableDeviceTypes_0003_0017_0001',
    'wirePSAFEARRAY', 'tagBSTRBLOB',
    '__MIDL_IOleAutomationTypes_0006', 'tagCALPWSTR'
]
