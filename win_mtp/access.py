...
Examples:
    ...
    >>> win_mtp.access.get_portable_devices()
...
# -------------------------------------------------------------------------------------------------
# ToDos: finish documentation, Examples
...
def get_content_from_device_path(dev: PortableDevice, path: str) -> Optional[PortableDeviceContent]:
    ...
    Examples:
        ...
        >>> w =win_mtp.access.get_content_from_device_path(dev[0], n)
        >>> str(w)[:46]
...
def makedirs(dev: PortableDevice, path: str) -> Optional[PortableDeviceContent]:
    ...
    Examples:
        ...
        >>> str(win_mtp.access.makedirs(dev[0], n))[:22]
